  ...
  return (
    <section className="relative z-10 bg-primary/[.03] py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          title="Some of Our Investors"
          paragraph="We are committed to deliver excellent service"
          center
        />
