            ...
            <div className=""> {/*w-full px-4 lg:w-8/12*/}
              <div>
                ...
                <div>
                  ...
                  Blockheath is a digital asset manager that deploys discretionary long/short equity, systematic, 
                  and macro investing strategies, complemented by a growing portfolio of private venture investments
                  </p>
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      {/*<Image
                        src="/images/blog/4799045.jpg"
                        alt="image"
                        fill
                        className="object-cover object-center"
                       />*/}  
                       <img src="/images/blog/investors.jpg" width="800" height="500" 
                        alt="image"></img>
                    </div>
                  </div>
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  We function on a scale that reduces the barrier to entry, enabling anyone to join us as a partner and become one of our 
                  investors. The process of becoming an investor is straightforward and effortless. Prospective investors simply need 
                  to complete our investor form and deposit their investment funds with us. These funds are then added to our pool, 
                  from which we make investments. 
                    {/*<strong className="text-primary dark:text-white">
                      malesuada
                  </strong>*/} <br />
                  <br />
                    We specialize in procuring equities from promising startups and projects with the potential for substantial returns. 
                    Once we have made investment decisions, we notify our investors about the selected projects and startups, and 
                    distribute the acquired equities among them. Our investors are regularly informed about their potential earnings on 
                    a quarterly basis. To ensure that our investors receive the full benefit of their earnings, we charge a one-time 
                    service fee of 2.2% on investment funds. The earnings can be either credited to the investors' accounts or reinvested.  
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  ...
                  {/*<h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                    Start investing with us from $100 today
                  </h3>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Our investments options are splited into four asset classes. They are different benefits associated 
                    with each asset class. Our asset classes are;
              </p>*/}
                  
                  {/*<ul className="mb-10 list-inside list-disc text-body-color">
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Micro Invesmtnet class - $100 asset class.
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Standard class - $2000 asset class.
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Investor class - $10,000 asset class
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Elite class - from $100,000 asset class
                    </li>
              </ul>*/}
